import { Move, Role } from "./enum/GameEnum";
...
class Game {
  ...
  setBoard(index: number, player: number) {
    if (this.board[index] !== 0) return Move.NOT_MOVED;
